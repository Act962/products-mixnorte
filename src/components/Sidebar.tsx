...
import useCategorys from "@/contexts/categorys/hooks/use-categorys";
...
const Sidebar = ({
  ...
  const { categories, categoryLoading } = useCategorys();
                ...
                : categories.map((category, index) => (
                    <>
                      {index === 0 && (
                        <Button
                          variant={
                            selectedCategory === "Todos" ? "default" : "ghost"
                          }
                      ...
                      <Button
                        key={`${category.title}-button-${index}`}
                        variant={
